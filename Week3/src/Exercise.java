...
public class Exercise implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        panel.addGLEventListener(new Exercise());
    }
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        printMatrix(gl,"Translate 1 0.5");
        gl.glPopMatrix();
        
        gl.glPushMatrix();
        gl.glScaled(-1,-1,1);
        printMatrix(gl,"Scale -1 -1");
        gl.glPopMatrix();
        
        gl.glPushMatrix();
        gl.glRotated(180,0,0,1);
        printMatrix(gl,"Rotate 180");
