...
public class RevSphereVBO implements GLEventListener, MouseMotionListener, KeyListener{
    ...
    public static void main(String[] args) {
        ...
        // put it in a JFrame
        final JFrame jframe = new JFrame("Sphere VBO2");
        ...
        RevSphereVBO s = new RevSphereVBO();
