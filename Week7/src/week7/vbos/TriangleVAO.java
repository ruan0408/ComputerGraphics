 ...
 * 
 */
public class TriangleVAO implements GLEventListener {
	...
	//VAO ids for each object we want to draw
	private int vaoIds[] = new int[2];
	
	public void setUpVAOs(GL2 gl) {
		//Generate the ids.
    ...
    public void dispose(GLAutoDrawable drawable) {
    	GL2 gl = drawable.getGL().getGL2();
    	gl.glDeleteBuffers(4,bufferIds,0);
    	gl.glDeleteVertexArrays(2,vaoIds,0);
        //gl.glDeleteProgram(shaderprogram); //for shaders 
    }
    ...
    public static void main(String[] args) {
        ...
        TriangleVAO triangle = new TriangleVAO();
