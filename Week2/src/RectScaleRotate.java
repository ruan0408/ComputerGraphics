...
public class RectScaleRotate implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        panel.addGLEventListener(new RectScaleRotate());
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        //Compare non-uniform scaling before vs after rotating.
        gl.glScaled(1,3,1);
