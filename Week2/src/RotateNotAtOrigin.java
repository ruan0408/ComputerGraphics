 ...
 * with 2D transformations. In this example we rotate around an arbitrary point using a combination of transformations
 *
 * @author angf
 */

public class RotateNotAtOrigin implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        panel.addGLEventListener(new RotateNotAtOrigin());
    }
